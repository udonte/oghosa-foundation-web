...
import { reportsImpactMetrics } from "@/lib/constants/about/report";
  ...
  return (
    <main className="">
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        className="px-4 py-16 lg:px-24 lg:py-16"
      >
        <SectionHeader title="Annual Reports" />
      ...
      <ImpactSection stats={reportsImpactMetrics} />

      <CTASection
        title=" Need More Information?"
        subtitle="  Contact our finance team for additional reports or clarification"
        buttonOneText="Request Documentation"
