...
const footerLinks = {
  about: [
    ...
    { name: "Our Partners", path: "/support/partners" },
    { name: "FAQs", path: "/contact/faq" },
  ],
  work: [
    { name: "Education", path: "/work/education" },
    { name: "Sickle Cell Support", path: "/work/sickle-cell-support" },
    { name: "Food Security", path: "/work/food-security" },
    { name: "Skills Training", path: "/work/skills-training" },
  ],
  workWithUs: [
    { name: "Our Communities", path: "/location/communities" },
    { name: "Impact Areas", path: "/location/impact" },
    { name: "Partnerships", path: "/support/partner" },
