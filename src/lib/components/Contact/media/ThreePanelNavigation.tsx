...
import { FaFileAlt, FaLock, FaMicrophone } from "react-icons/fa";
...
const ThreePanelNavigation = () => {
  const panels = [
    ...
    },
    {
      ...
      description: "Schedule an interview with our team",
      href: "#calendly-embed",
    },
    {
      icon: <FaLock className="h-6 w-6" />,
      title: "Embargoed Materials",
      description: "Access secure press materials",
      href: "/contact/media/secure",
    },
  ];
